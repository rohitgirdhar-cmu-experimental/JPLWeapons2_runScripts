...
GLOG_logtostderr=0 nice -n 19 $CODE_PATH/buildIndex.bin \
    -d /memexdata/Dataset/processed/0008_JPLWeapons2/features/CNN/pool5_fullImg_normed \
    -n /memexdata/Dataset/processed/0008_JPLWeapons2/lists/Images.txt \
    -s /memexdata/Dataset/processed/0008_JPLWeapons2/Search/indexes/fullImg_ITQ_256bit.index \
    -b 256 \
    -t 1 \
    -a 900 \
    --nTrain 500000
